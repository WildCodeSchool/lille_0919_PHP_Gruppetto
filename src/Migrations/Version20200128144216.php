...
final class Version20200128144216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE participation_like');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participation_like ADD CONSTRAINT FK_7017FFFA71F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
        $this->addSql('ALTER TABLE participation_like ADD CONSTRAINT FK_7017FFFAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
